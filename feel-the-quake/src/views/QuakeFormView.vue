<template>
  <main class="flex justify-center items-center h-full min-h-screen bg-cyan-100">
    <div
      class="relative flex flex-col h-fit w-full pb-12 pt-16 px-6 mx-4 bg-white border-[1.5px] border-b-[6px] border-cyan-500 shadow-lg rounded-xl">
      <button type="button" v-if="formIndex > 0 && formIndex < 4" @click="formIndex--"
        class="absolute top-2 left-3 flex items-center justify-center aspect-square rounded-full w-10 text-xl text-center text-cyan-500 border-[1px] border-neutral-200 shadow">
      ...
      <section v-show="formIndex == 0">
        ...
        <form class="flex flex-col items-center">
          ...
          <button type="button" @click="formIndex++"
            class="relative flex gap-2 rounded-xl py-2 px-6 border-2 border-cyan-200 bg-cyan-500 font-semibold text-white text-xl w-fit shadow-md"
        ...
        <form class="flex flex-col items-center">
          <ul class="flex gap-3 w-fit mb-6">
            <li
              ...
              @click="selectionIndecies[0] = 1" :class="{ 'bg-teal-100': selectionIndecies[0] >= 1 }">1</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[0] = 2" :class="{ 'bg-teal-200': selectionIndecies[0] >= 2 }">2</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[0] = 3" :class="{ 'bg-teal-300': selectionIndecies[0] >= 3 }">3</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[0] = 4" :class="{ 'bg-teal-400': selectionIndecies[0] >= 4 }">4</li>
          </ul>
      ...
      <section v-show="formIndex == 3">
        ...
        <form class="flex flex-col items-center">
          <ul class="flex gap-3 w-fit mb-6">
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[3] = 1" :class="{ 'bg-teal-100': selectionIndecies[3] >= 1 }">1</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[3] = 2" :class="{ 'bg-teal-200': selectionIndecies[3] >= 2 }">2</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[3] = 3" :class="{ 'bg-teal-300': selectionIndecies[3] >= 3 }">3</li>
            <li
              class="flex items-center justify-center aspect-square rounded-full w-10 text-2xl text-center font-bold text-cyan-700 border-[1px] border-neutral-200 shadow"
              @click="selectionIndecies[3] = 4" :class="{ 'bg-teal-400': selectionIndecies[3] >= 4 }">4</li>
          </ul>
          <div class="text-center bg-cyan-100 p-4 rounded-xl min-h-[8rem]">
          ...
          <div class="h-[0.10rem] w-1/2 bg-sky-100 my-8"></div>
          <button type="button" @click="formIndex++"
            class="relative rounded-xl py-2 px-6 border-2 border-cyan-200 bg-cyan-500 font-semibold text-white text-xl w-fit shadow-md">
            Предаване
          </button>
        </form>
      </section>
        ...
        <form class="flex flex-col items-center">
          ...
          <RouterLink to="/hub">
            <button type="button" @click="turnInForm()"
              class="relative rounded-xl py-2 px-6 border-2 border-cyan-200 bg-teal-500 font-semibold text-white text-xl w-fit shadow-md">
              Връщане обратно
            </button>
          </Routerlink>
        </form>
      ...
      <div v-show="formIndex < 4" class="flex gap-2 absolute w-fit left-0 right-0 mx-auto top-[95%]">
        <div class="aspect-square w-[0.60rem] border-[1px] border-cyan-500 rounded-full"
          :class="{ 'bg-cyan-500': formIndex >= 0 }"></div>
        <div class="aspect-square w-[0.60rem] border-[1px] border-cyan-500 rounded-full"
          :class="{ 'bg-cyan-500': formIndex >= 1 }"></div>
        <div class="aspect-square w-[0.60rem] border-[1px] border-cyan-500 rounded-full"
          :class="{ 'bg-cyan-500': formIndex >= 2 }"></div>
        <div class="aspect-square w-[0.60rem] border-[1px] border-cyan-500 rounded-full"
          :class="{ 'bg-cyan-500': formIndex >= 3 }"></div>
      </div>
    </div>
  </main>
</template>
